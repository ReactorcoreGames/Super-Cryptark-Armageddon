...
Thats all. Play the game - either campaign, rogue mode, excavation - the changes will be apparent as you play the game. You will encounter new weapons/items and see the new ships filled with crazy new enemies. 

My favorite way to play is Rogue mode, you start with a good loadout and you can swap items you find in the pods scattered around the ship, adapting to the situation as you go.

NOTE: After installing the mod, the game may crash ONCE and only once as it resets itself due to detecting and loading all the new content and changes, discarding the old settings in the process. This is normal and only happens once. Its not elegant, but after this first-time crash, the game will work flawlessly from start to finish, provided the above action list to prevent crashes is respected.
...
While new enemy ships *are* more crowded, challenging and bigger, the player in this mod is also 50x more powerful than in base game, able to truly annihilate entire armies on their own now.

I wanted a game that I could boot up, give me randomized experience and let me blow stuff up for 30-60 minutes with some surprises created by procedural generation, so I can refresh and go continue working on other stuff.

Load up on heavy weapons, spare no expense, hold down the trigger and kick ass, pilot. The ARMAGEDDON is ON!
...
<img width="1280" height="800" alt="Screenshot 2017-10-28 16 32 18" src="https://github.com/user-attachments/assets/35af5789-dd38-4ee1-a103-0ad11d0361fb" />
...
<img width="985" height="581" alt="Screenshot 2017-10-30 14 12 24" src="https://github.com/user-attachments/assets/e24a63dc-6da1-42bd-b34d-fc3a518198fa" />
...
## Links
Hey, check out everything else I do too: ✨🚀
